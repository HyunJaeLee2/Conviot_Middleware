#!/bin/sh 
LIST_OF_APPS="mosquitto mosquitto-clients libtool automake autoconf libmysqlclient-dev libssl-dev flex byacc bison libconfig-dev gcc make cmake cmake-gui cmake-curses-gui"
