...
//
cap_result DBHandler_VerifyDeviceApiKey(IN MYSQL *pDBconn, IN cap_string strDeviceId, IN OUT char *pszApiKey);
cap_result DBHandler_VerifyServiceApiKey(IN MYSQL *pDBconn, IN cap_string strProductName, IN OUT char *pszApiKey);

cap_result DBHandler_RetrieveDeviceApiKey(IN MYSQL *pDBconn, IN cap_string strDeviceId, IN char **ppszApiKey);
cap_result DBHandler_RetrieveServiceApiKey(IN MYSQL *pDBconn, IN cap_string strProductName, IN char **ppszApiKey);
...
cap_result DBHandler_MakeConditionListWithDevice(IN MYSQL *pDBconn, IN cap_string strDeviceId, IN cap_string strVariableName, IN OUT cap_handle hRelatedConditionList);
